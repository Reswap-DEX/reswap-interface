...
import { Currency, CurrencyAmount, ETHER, JSBI, Token, TokenAmount } from '@reswap/sdk'
...
/**
 * Returns a map of the given addresses to their eventually consistent FTM balances.
 */
