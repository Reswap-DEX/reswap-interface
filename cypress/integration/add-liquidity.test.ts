describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('contain.text', 'FTM')
  })
  ...
  it('does not crash if FTM is duplicated', () => {
    ...
    cy.get('#add-liquidity-input-tokena .token-symbol-container').should('contain.text', 'FTM')
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('not.contain.text', 'FTM')
  })
